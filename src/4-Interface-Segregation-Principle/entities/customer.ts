import { Customer, CustomerOrder, EntrepriseCustomerProtocol, IndividualCustomerProtocol } from "./interfaces/customers";
...
export class EntrepriseCustomer implements EntrepriseCustomerProtocol, CustomerOrder {
    razaoSocial: string;
    nomeFantasia: string;
    email: string;
    phone: string;
