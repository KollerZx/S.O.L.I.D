...
/**
 * De maneira bem simples, o LSP define que subtipos podem ser substituidos por seus tipos de base, ou seja, se o programa espera um Animal, 
 * algo do tipo Cachorro (que herda de Animal) pode substituir o Animal.
 * 
 * No nosso caso, as classes FiftyPercentDiscount e WithoutDiscount herdam de Discount,logo, podemos substituir um objeto do tipo Discount
 * por um objeto do tipo FiftyPercentDiscount ou WithoutDiscount.
 */


describe("Liskok Substitution Principle", () => {
